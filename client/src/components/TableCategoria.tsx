...
export const Tablecategoria = () => {
  ...
  const Editcategoria = (e: categoria_schema) => {
    setmodal(true)
    HandleEditcategoria(e)
  }

  const onSubmit: SubmitHandler<categoria_schema> = (dataCategoria) => {
          ...
          <div className="modal">
            <div className="modal-content">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <input type="text" {...register("nombre")} placeholder="nombre categoria" />
                <input type="text" {...register("descripcion")} placeholder="descripcion" />
